...
class RentalPropertiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rental_property" do
    assert_difference('RentalProperty.count') do
      post rental_properties_url, params: { rental_property: { house_age: @rental_property.house_age, propety_name: @rental_property.propety_name, remarks: @rental_property.remarks, rent: @rental_property.rent, street_address: @rental_property.street_address } }
    end
  ...
  test "should update rental_property" do
    patch rental_property_url(@rental_property), params: { rental_property: { house_age: @rental_property.house_age, propety_name: @rental_property.propety_name, remarks: @rental_property.remarks, rent: @rental_property.rent, street_address: @rental_property.street_address } }
